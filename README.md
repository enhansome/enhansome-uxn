...
* [Uxntal Cheatsheet](https://github.com/weeble/uxn-cheatsheet) ⭐ 29 | 🐛 1 | 📅 2025-11-14 - Opcode Cheatsheet.
...
* [Teletype](https://github.com/csboling/teluxn) ⭐ 14 | 🐛 0 | 🌐 C | 📅 2021-06-28 - Incomplete.
* [iOS](https://github.com/paiv/uxn-ios) ⭐ 13 | 🐛 0 | 🌐 C | 📅 2024-10-18 - Incomplete.
* [STM32duino](https://github.com/cassvs/arduxno-demo) ⭐ 12 | 🐛 0 | 🌐 C | 📅 2021-11-02 - Incomplete.
* [IBM PC](https://github.com/cr1901/pcuxn) ⭐ 8 | 🐛 0 | 🌐 Python | 📅 2021-08-23 - Incomplete.
* [PlayStation Vita](https://github.com/ivodopiviz/uxnvita) ⭐ 8 | 🐛 0 | 🌐 C | 📅 2022-11-27 - Incomplete.
...
* [uxn.py](https://github.com/max22-/uxnemu.py) ⭐ 25 | 🐛 0 | 🌐 Python | 📅 2022-04-18 - Python implementation of the VM.
* [auxn](https://github.com/saucesaft/auxn) ⭐ 6 | 🐛 0 | 🌐 Rust | 📅 2023-01-17 - Incomplete.
* [buxn-dbg](https://github.com/bullno1/buxn-dbg) ⭐ 2 | 🐛 0 | 🌐 C | 📅 2025-07-18 - Uxntal step debugger.
...
* [Worm](https://github.com/origedit/worm) ⭐ 5 | 🐛 0 | 🌐 Makefile | 📅 2024-03-26 - Dune themed snake game for Varvara.
...
* [buxn-asm](https://github.com/bullno1/buxn) ⭐ 24 | 🐛 1 | 🌐 C | 📅 2025-12-30 - Uxntal assembler with a type checker.
...
* [Uxn-disassembler](https://github.com/Liorst4/uxn-disassembler) ⭐ 6 | 🐛 0 | 🌐 Python | 📅 2023-05-08 - Disassembler writen in Uxntal
* [Pyuxntaldisasm](https://github.com/DeltaF1/pyuxntaldisasm) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2021-11-23 - Very basic disassembler for Uxn ROMs.
...
* [B](https://github.com/tsoding/b) ⭐ 714 | 🐛 47 | 🌐 Rust | 📅 2025-10-29 - Compiler for the B Programming Language implemented in Crust, has support for uxn target.
